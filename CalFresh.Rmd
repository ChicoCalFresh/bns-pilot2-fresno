...
plot_frq(bns$meals_per_week_mp, drop.empty = FALSE, vjust=-0.2, ylim = c(0,1.5)) + 
...
Of people who receive a campus meal plan, `r unname(table(bns$meals_per_week_mp)['11+'])` person receive more than 11 meals per week , while `r unname(table(bns$meals_per_week_mp)['< 11'])` people receive less than 11 meals per week. 
...
<div class = "col-md-6">
```{r, fig.height=3, fig.width=4}
plot_frq(bns$calfresh_eligible, ylim=c(0,90), title = "Most Likely to be CalFresh Eligible") + 
