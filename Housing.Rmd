...
plot_frq(bns$q23, ylim=c(0,110)) + xlab('') + ylab("Frequency")
```
</div>
...
<div class = "col-md-6">
```{r, fig.height=4, fig.width=4}
plot_frq(bns$q24, ylim=c(0,90)) + xlab('') + ylab("Frequency")
```
</div>
...
p1 <- plot_frq(bns$q34, wrap.title=40, wrap.labels =12, ylim = c(0,130), 
               title = 'How many times have you been unsure of where you were going to sleep at night?') + xlab('') + ylab("Frequency")
p2 <- plot_frq(bns$q35, wrap.labels =10, ylim = c(0,110), title = 'How many times have you moved?') + xlab('')
...
```{r, fig.width=8.3}
plot_frq(bns$q37, ylim=c(0,18), wrap.labels = 17, sort.frq = 'desc') + xlab('') + ylab("Frequency")
```
