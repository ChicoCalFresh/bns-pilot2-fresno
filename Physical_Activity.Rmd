...
- The data indicates that the majority of participants claim to have done `r names(sort(table(bns$moderate_exercise_past_week), decreasing = TRUE))[1]` days of moderate exercise in the past week (`r unname(sort(table(bns$moderate_exercise_past_week), decreasing = TRUE))[1]` people). The general trend is that as the number of days increases, the number of students who exercised for those given number of days decreases. Moderate exercise seems to be the most commonly performed type of exercise from the graph above (typically the highest number of days per week out of all exercise types).
