...
## Academic Year
**On average, during the academic year, how many hours of sleep do you get in a typical 24-hour period?**[^1] *Note that for the week days we have `r print_n_reporting("q84")`, while for the weekends we have `r print_n_reporting("q85")`*

#### During the Week (Monday-Friday)
```{r, fig.height=3.5, fig.width=7}
hist_with_box('q84', 47, 10, 0.4, NULL, c(0,55), 'Number of Hours')
```
...
```{r, fig.height=3.5, fig.width=7}
hist_with_box('q85', 35, 6, 0.4, NULL, c(0,40), 'Number of Hours')
```
...
```{r}
hist_with_box('q86', 17, 4, 0.4, NULL, c(0,20), 'Days Per Month')
```
...
plot_frq(bns$q89, ylim=c(0,90)) + xlab('') + ylab("Frequency")
```
</div>
